...
Dos partes en una misma sesión: (A) la "sesión cero" real de mesa — alinear expectativas con el grupo, explicar el setting y guiar la creación de personajes — y (B) correr el one-shot de graduación tal como está estructurado en [[Arco 0 - Examen Final (One-Shot)]]: presentar el grupo en ficción, un ejercicio de simulación que se complica con una amenaza real (piratas), y cerrar con la revelación del contrato obligatorio.

## Parte A — Antes de jugar: sesión cero de mesa

### Cómo presentar el setting (resumen para leer/parafrasear a los jugadores)
...
### Qué esperar de sus personajes (expectativas de campaña, para compartir con el grupo)
...
- 1-2 refuerzos no desplegados de entrada, para ajustar dificultad.
