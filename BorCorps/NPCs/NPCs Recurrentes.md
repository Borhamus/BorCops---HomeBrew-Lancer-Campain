...
A medida que un NPC gana peso narrativo — reaparece en una segunda sesión, se vuelve aliado o rival recurrente — crear su nota completa en esta carpeta y agregar el link acá abajo con una línea de resumen.

## Lista (completar a medida que aparezcan)

- *(vacío por ahora — se completa sesión a sesión)*
