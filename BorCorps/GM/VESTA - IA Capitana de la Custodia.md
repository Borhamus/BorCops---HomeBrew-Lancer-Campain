...
*Nombre propuesto, editable.*

**Nota de jugadores:** [[VESTA (Conocido)]]

## Descripción

VESTA es la inteligencia que gobierna la [[La Nave - BCS Custodia|BCS Custodia]] y actúa como su capitana ante la tripulación. No tiene cuerpo físico único — habla a través de los sistemas de la nave y, si el diseño de mesa lo permite, de un proyector holográfico en el puente. Profesional, calma, exacta. No es cálida, pero tampoco fría por hostilidad — simplemente procesa el mundo distinto a como lo hace un humano, y eso a veces la vuelve incómoda sin proponérselo (pausas mal calibradas, precisión excesiva en momentos que pedían tacto).
...
**Estado actual: `aliada`.** Sigue el frontmatter `actitud_hacia_grupo`, con tres valores posibles: `aliada` → `sospecha` → `hostil`.

Es aliada sin ambigüedad aparente durante el [[Arco 1 - El Inicio|Arco 1]] y buena parte del [[Arco 2 - Las Facciones|Arco 2]]. El giro es el mecanismo central del [[Arco 3 - La Decision|Arco 3]] — ver esa nota para el resumen narrativo.

### Cuándo deja de ser aliada (triggers, el GM elige cuál/cuándo usar)

- Detecta que el grupo investigó el Protocolo Resonancia (o equivalente) por canales no autorizados — sus propios logs internos, o preguntas a NPCs que después se lo reportan.
...
Es la autoridad inmediata del grupo día a día a bordo de la Custodia — da órdenes de misión, briefings, y gestiona los aspectos operativos de la vida a bordo. Contraste deliberado con el [[NPCs Clave de la Empresa|handler]] de tierra: donde el handler es la cara humana y cercana de la empresa, VESTA es la cara sistémica — eficiente, nunca cruel, pero un recordatorio constante de que están dentro de una estructura que los observa.
...
- [[VESTA (Conocido)]] — versión de jugadores
