...
fecha_real:
fecha_en_juego: "Primeros días a bordo de la BCS Custodia"
---

## Objetivo de la sesión

Establecer la nueva normalidad del grupo como escuadrón activo: la vida a bordo de la [[La Nave - BCS Custodia|Custodia]] bajo el mando de [[VESTA - IA Capitana de la Custodia|VESTA]], y su primera misión real — la recuperación en [[Mision 01 - Kharnis|Kharnis]]. Es la primera exposición del grupo al lore oculto de la campaña, pero diseñada para que **no puedan conectar ningún punto todavía** — ver la sección de pistas de esa nota.
...
5. **El Centinela de Kharnis (combate de jefe)**: 1 vs. grupo. Termina en victoria, huida exitosa, o cualquier resultado intermedio — ver [[Mision 01 - Kharnis]] para el detalle del encuentro.
6. **Extracción**: en el mejor de los casos, el grupo vuelve a la Custodia con la gema. Cerrar la sesión con la entrega del artefacto — sembrando (sin explicar) que ese proceso de entrega no es tan simple ni tan transparente como parece.

## NPCs presentes

- [[VESTA - IA Capitana de la Custodia|VESTA]] — da el briefing, acompaña la misión por comunicaciones.
- El [[NPCs Clave de la Empresa|handler]] — puede aparecer solo al inicio (asignación del contrato) o quedar fuera de esta sesión, a elección de mesa.
- El Centinela de Kharnis — ver [[Mision 01 - Kharnis]].

## Combates / Encuentros

Ver el detalle completo en [[Mision 01 - Kharnis]]:

- Hostigamiento inicial de los enjambres de Kharnis (menor).
